<?php $__env->startSection('title', 'Reports - UoK ARG Portal'); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <select class="form-select" id="proposal-grant-filter">
                                ...
                                <?php $__currentLoopData = $allgrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($grant->grantid); ?>"><?php echo e($grant->grantid); ?> (<?php echo e($grant->finyear); ?>)</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-select" id="proposal-theme-filter">
                                ...
                                <?php $__currentLoopData = $allthemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-3">
                            <select class="form-select" id="proposal-department-filter">
                                ...
                                <?php $__currentLoopData = $alldepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($dept->depid); ?>"><?php echo e($dept->shortname); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <select class="form-select" id="financial-year-filter">
                                ...
                                <?php $__currentLoopData = $allfinyears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($year->finyear); ?>"><?php echo e($year->finyear); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-4">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/felix/projects/kabianga-research-portal/Kabianga-arg-final/resources/views/pages/reports/index.blade.php ENDPATH**/ ?>