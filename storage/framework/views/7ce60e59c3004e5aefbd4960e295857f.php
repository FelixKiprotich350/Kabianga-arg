<?php $__env->startSection('title', isset($prop) ? 'Edit Proposal - UoK ARG Portal' : 'New Proposal - UoK ARG Portal'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <?php if(isset($grants)): ?>
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2><?php echo e(isset($prop) ? 'Edit Proposal' : 'New Proposal'); ?></h2>
                    <p class="text-muted"><?php echo e(isset($prop) ? $prop->proposalcode : 'Create a new research proposal'); ?></p>
                </div>
                                        ...
                                        <select name="grantnofk" class="form-select" required>
                                            ...
                                            <?php $__currentLoopData = $grants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($grant->grantid); ?>"
                                                    <?php echo e(isset($prop) && $prop->grantnofk == $grant->grantid ? 'selected' : ''); ?>>
                                                    <?php echo e($grant->grantname ?? $grant->title); ?></option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="themefk" class="form-select" required>
                                            ...
                                            <?php $__currentLoopData = $themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($theme->themeid); ?>"
                                                    <?php echo e(isset($prop) && $prop->themefk == $theme->themeid ? 'selected' : ''); ?>>
                                                    <?php echo e($theme->themename); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="departmentfk" class="form-select" required>
                                            ...
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($department->depid); ?>"
                                                    <?php echo e(isset($prop) && $prop->departmentidfk == $department->depid ? 'selected' : ''); ?>>
                                                    <?php echo e($department->shortname); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="highestqualification" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->highqualification : ''); ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Office Phone</label>
                                        <input type="tel" name="officephone" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->officephone : ''); ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Cell Phone</label>
                                        <input type="tel" name="cellphone" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->cellphone : ''); ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Fax Number</label>
                                        <input type="tel" name="faxnumber" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->faxnumber : ''); ?>" required>
                                    </div>
                                </div>
                            ...
                            <form id="researchForm">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="researchtitle" class="form-control"
                                        value="<?php echo e(isset($prop) ? $prop->researchtitle : ''); ?>" required>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Start Date</label>
                                        <input type="date" name="commencingdate" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->commencingdate : ''); ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">End Date</label>
                                        <input type="date" name="terminationdate" class="form-control"
                                            value="<?php echo e(isset($prop) ? $prop->terminationdate : ''); ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Objectives</label>
                                    <div id="objectives-editor" style="height: 150px;"></div>
                                    <textarea name="objectives" class="d-none" required><?php echo e(isset($prop) ? $prop->objectives : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Hypothesis</label>
                                    <div id="hypothesis-editor" style="height: 150px;"></div>
                                    <textarea name="hypothesis" class="d-none" required><?php echo e(isset($prop) ? $prop->hypothesis : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Significance</label>
                                    <div id="significance-editor" style="height: 150px;"></div>
                                    <textarea name="significance" class="d-none" required><?php echo e(isset($prop) ? $prop->significance : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Ethical Considerations</label>
                                    <div id="ethicals-editor" style="height: 150px;"></div>
                                    <textarea name="ethicals" class="d-none" required><?php echo e(isset($prop) ? $prop->ethicals : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Expected Output</label>
                                    <div id="outputs-editor" style="height: 150px;"></div>
                                    <textarea name="outputs" class="d-none" required><?php echo e(isset($prop) ? $prop->expoutput : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Economic Impact</label>
                                    <div id="economicimpact-editor" style="height: 150px;"></div>
                                    <textarea name="economicimpact" class="d-none" required><?php echo e(isset($prop) ? $prop->socio_impact : ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Research Findings</label>
                                    <div id="res_findings-editor" style="height: 150px;"></div>
                                    <textarea name="res_findings" class="d-none" required><?php echo e(isset($prop) ? $prop->res_findings : ''); ?></textarea>
                                </div>
    ...
    <script>
        ...
        let designItems = [];
        let workplanItems = [];
        let proposalId = <?php echo e(isset($prop) ? $prop->proposalid : 'null'); ?>;
        let quillEditors = {};
                    ...
                    fetch(`/api/v1/proposals/${proposalId}/submit`, {
                        ...
                        .then(data => {
                            if (data.type === 'success') {
                                ...
                                setTimeout(() => {
                                    window.location.href = '<?php echo e(route('pages.proposals.index')); ?>';
                                }, 2000);
                            } else {
                                ARGPortal.showError(data.message);
                            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/felix/projects/kabianga-research-portal/Kabianga-arg-final/resources/views/pages/proposals/proposalform.blade.php ENDPATH**/ ?>